package com.example.wadagang.Fragments;
...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        status=view.findViewById(R.id.Status_Box);
        change_sta=view.findViewById(R.id.Changebtn);


        // profile image refrence in storage
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                status.setText(user.getProfilestatus());
        ...
        change_sta.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void ChangeStatus() {
            ...
            Intent i = new Intent(getActivity(), ChangeStatus.class);
            startActivity(i);
